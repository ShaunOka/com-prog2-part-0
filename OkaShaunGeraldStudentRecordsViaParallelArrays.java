...
public class OkaShaunGeraldStudentRecordsViaParallelArrays {
    ...
    public void sortArrays(String[] id, String[] name, String[] course, int[] yearLevel,
        ...
        for (int index1 = 0; index1 < name.length; index1++) {
            int sortIndex = index1;
            for (int index2 = index1 + 1; index2 < name.length; index2++) {
                if (name[sortIndex].compareTo(name[index2]) > 0) {
                    sortIndex = index2;
                }
            }
            if (!name[sortIndex].equals(name[index1])) {
...
/*
SAMPLE OUTPUT
Please enter number of student records to be created: a
ERROR: Invalid number.
Please try again.
Please enter number of student records to be created: 0
Please enter a number minimum of 1 and maximum of 50
Please enter number of student records to be created: 500
Please enter a number minimum of 1 and maximum of 50
...
Please enter preliminary grade: a
ERROR: Invalid number.
Please try again.
Please enter preliminary grade: 1000
Please enter a number minimum of 65 and maximum of 99
Please enter preliminary grade: 4
Please enter a number minimum of 65 and maximum of 99
Please enter preliminary grade: 99
Please enter midterm grade: 99
Please enter tentative final grade: 99
Student record (2):
Please enter id number: 124
Please enter name: Gerald
...
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
               ...
               Shaun        123             BSCS      1        99         99                99       99
              Gerald        124             BSIT      2        99         98                97       98
                 Oka        125            BSMMA      3        96         95                94       95
